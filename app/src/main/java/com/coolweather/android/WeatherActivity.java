...
public class WeatherActivity extends AppCompatActivity {
    ...
    private void loadBingPic() {
        ...
        HttpUtil.sendOkHttpRequest(bingUrl, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                final String bingResponse=response.body().string();
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Glide.with(WeatherActivity.this).load(bingResponse).into(bingPicImg);
                    }
                });
            }
    ...
    public void requestWeather(final String weatherId) {
        String weatherUrl="http://guolin.tech/api/weather?cityid="+weatherId +"&key=ed28b054f3334406a49b77bed3f9335a";
